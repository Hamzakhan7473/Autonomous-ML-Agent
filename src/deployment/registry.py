...
class ModelRegistry:
    ...
    async def save_model(
        ...
        try:
            ...
            self.metadata[model_id] = {
                ...
                'meta_features': meta_features,
                'performance': leaderboard.iloc[0].to_dict() if not leaderboard.empty else {}
            }
            self._save_metadata()
    ...
    async def get_meta_learning_warm_starts(self, meta_features: Dict[str, Any]) -> Dict[str, Any]:
            ...
            for model_id, score in similar_models[:3]:  # Top 3 similar models
                try:
                    ...
                    warm_starts[model_id] = {
                        ...
                        'performance': model_data['metadata'].get('leaderboard', [{}])[0],
                        'meta_features': model_data['metadata'].get('meta_features', {})
                    }
                except Exception as e:
