...
class MLflowTracker:
    ...
    def log_artifacts(self, artifacts_dir: str, artifact_path: str | None = None):
        """
    ...
    def log_figure(self, figure, artifact_file: str, artifact_path: str | None = None):
        """
    ...
    def log_text(self, text: str, artifact_file: str, artifact_path: str | None = None):
        """
    ...
    def transition_model_stage(
        self, model_name: str, version: str, stage: str, description: str | None = None
    ):
        """
    ...
    def export_experiment_results(
        self, output_path: str, include_artifacts: bool = True
    ) -> str:
        """
...
def create_mlflow_signature(X_sample: pd.DataFrame, y_sample: pd.Series) -> Any:
    """
