...
class OptunaOptimizer:
    ...
    def _fallback_optimization(self, X: np.ndarray, y: np.ndarray) -> BaseEstimator:
        ...
        optimizer = HyperparameterOptimizer(self.model, param_grid, self.cv, self.scoring)
...
def optimize_model(model: BaseEstimator, X: np.ndarray, y: np.ndarray,
                  method: str = 'grid', cv: int = 5, scoring: str = 'accuracy',
                  n_trials: int = 100) -> BaseEstimator:
    """
