...
class MLPlanner:
    ...
    def create_plan(self, schema: DatasetSchema, summary: Dict[str, Any], 
                    prior_runs: Optional[List[Dict[str, Any]]] = None) -> MLPlan:
    ...
    def _prepare_context(self, schema: DatasetSchema, summary: Dict[str, Any], 
                        prior_runs: Optional[List[Dict[str, Any]]]) -> str:
...
"""
    ...
    def _parse_plan_response(self, response: str, schema: DatasetSchema) -> MLPlan:
        ...
        try:
            ...
            required_fields = ['preprocessing_steps', 'models_to_try', 'hyperparameter_strategies', 
                             'evaluation_metrics', 'reasoning', 'confidence']
    ...
    def _fallback_plan(self, schema: DatasetSchema, summary: Dict[str, Any]) -> MLPlan:
        ...
        if schema.n_rows < 1000:
            ...
            # Medium dataset
            models_to_try = ["logistic_regression", "random_forest", "xgboost", "gradient_boosting"]
        else:
            # Large dataset
            models_to_try = ["random_forest", "xgboost", "lightgbm", "gradient_boosting"]
